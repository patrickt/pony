module Semantics.C.Conversions where
  ...
  rectifyTypeQualifiers :: TypeQualifier -> Attribute
  rectifyTypeQualifiers QConst    = Const
  rectifyTypeQualifiers QRestrict = Restrict
  rectifyTypeQualifiers QVolatile = Volatile
